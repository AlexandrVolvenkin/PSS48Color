...
enum TYPE_INDICATION
{
    ...
    NAMUR_INDICATION = 2,			// Индикация недостоверности сигнала namur.
    PREVENTIVE	 = 3,			// Предупредительная сигнализация
    EMERGENCY	 = 4,			// Аварийная сигнализация

    IND_PREVENTIVE = 5,			// Индикация + предупредительная сигнализация
    IND_EMERGENCY  = 6,			// Индикация + аварийная сигнализация
